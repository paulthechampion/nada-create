 ...
 * @hidden
 */
var PersisterImpl = /** @class */ (function () {
    ...
    PersisterImpl.prototype._findOneAndModify = function (query, callback) {
        ...
        function handleCallback(err, response) {
            ...
            if (!document)
                return callback(null); // no match for criteria
    ...
    PersisterImpl.prototype._count = function (query, callback) {
        ...
        var options = {
            ...
            skip: query.skipCount // type in dts is incorrect
        };
...
var BulkOperationCommand = /** @class */ (function () {
    function BulkOperationCommand(collection, mapping) {
        this._mapping = mapping;
    ...
    BulkOperationCommand.prototype.addUpdate = function (id, changes) {
        var query = {
            _id: id
        };
        this.updated++;
