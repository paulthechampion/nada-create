 ...
 * @hidden
 */
var NumberMapping = /** @class */ (function (_super) {
    __extends(NumberMapping, _super);
    function NumberMapping() {
        return _super.call(this, 32 /* Number */) || this;
    }
    ...
    NumberMapping.prototype.write = function (context, value) {
        if (value == null)
            return null;
        if (typeof value !== "number") {
            context.addError("Expected number.");
...
exports.NumberMapping = NumberMapping;
